...
*The tool allows for easy conversion of a .STEP file into a .JSON file format. *In addition to basic surface information, there is also a function that takes care of holes present in the object's surface.
